  ...
  const handleDeleteComment = async (commentId) => {
    ...
    if (confirm("Bạn có chắc chắn muốn xóa bình luận này?")) {
      try {
        ...
        const baseUrl = process.env.NEXT_PUBLIC_API_URL || 'http://https://movie-streaming-v2-be.onrender.com';
        let endpoint;
        let options = {};
                        ...
                        {showSaveOptions && (
                          <div className={styles.saveOptionsDropup}>
                            <div className={styles.saveOptionsRow}>
                              <button
                                className={`${styles.saveOptionButton} ${isWatchLater ? styles.active : ""
                                  }`}
                                onClick={(e) => {
                                  e.stopPropagation();
                                  handleWatchLater();
                              ...
                              <button
                                className={`${styles.saveOptionButton} ${isFavorite ? styles.active : ""
                                  }`}
                                onClick={(e) => {
                                  e.stopPropagation();
                                  handleFavorite();
